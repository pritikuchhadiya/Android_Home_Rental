            ...
            private void upiPaymentDataOperation(ArrayList<String> data) {
                if (isConnectionAvailable(PayRent.this)) {
                    ...
                    if (status.equals("success")) {
                        ...
                        Toast.makeText(PayRent.this, "Payment cancelled by user.", Toast.LENGTH_SHORT).show();
                    }
                    else {
                        Toast.makeText(PayRent.this, "Transaction failed.Please try again", Toast.LENGTH_SHORT).show();
                    }
                } else {
                    Toast.makeText(PayRent.this, "Internet connection is not available. Please check and try again", Toast.LENGTH_SHORT).show();
                }
            }
